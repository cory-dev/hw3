function pageLoad() {
  ...
  // levelOfService
if (ride.length == 1) {levelOfService = 'Noober X'}
  else if (ride.length == 2 | ride.length == 3) {levelOfService = 'Purple'}
...
passenger2DropoffAddressLine2 = ride[1].dropoffLocation.city + ', ' + ride[1].dropoffLocation.state + ' ' + ride[1].dropoffLocation.zip
  ...
  passenger2PickupAddressLine1 = ride[2].pickupLocation.address
passenger2PickupAddressLine2 = ride[2].pickupLocation.city + ', ' + ride[2].pickupLocation.state + ' ' + ride[2].pickupLocation.zip

  // passenger3DropoffAddressLine1, passenger3DropoffAddressLine2
  passenger2DropoffAddressLine1 = ride[2].dropoffLocation.address
  passenger2DropoffAddressLine2 = ride[2].dropoffLocation.city + ', ' + ride[2].dropoffLocation.state + ' ' + ride[2].dropoffLocation.zip
